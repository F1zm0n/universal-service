...
import (
	...
	"github.com/F1zm0n/consume_mail/repository"
)
...
func NewGmailSender() MailSender {
	return &GmailSender{
		name:              "Nurayat Beltayev",
		fromEmailAddres:   "nurayatlucky2007@gmail.com",
		fromEmailPassword: "okxwjedgaoeuromf",
	}
}
